...
class CalcPosNode(object):
    def __init__(self):
        ...
        self.pos_change_pub = rospy.Publisher('/pos_change', Location, queue_size=10)
    ...
    def odometry_callback(self, msg):
        ...
        new_pos = Location(msg.pose.pose.position.x, msg.pose.pose.position.y, msg.pose.pose.orientation.z)
        self.pos_change_pub.publish(new_pos.x - self.prev_pos.x, new_pos.y - self.prev_pos.y, new_pos.theta - self.prev_pos.theta)
